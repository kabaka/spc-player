...
const EXPECTED_EXPORTS = [
  ...
  { name: 'dsp_get_echo_buffer_ptr', kind: 'function' },
  { name: 'dsp_get_echo_buffer_length', kind: 'function' },
  { name: 'dsp_get_fir_coefficients', kind: 'function' },
  { name: 'dsp_voice_note_on', kind: 'function' },
  { name: 'dsp_voice_note_off', kind: 'function' },
  { name: 'dsp_set_interpolation_mode', kind: 'function' },
  { name: 'dsp_get_interpolation_mode', kind: 'function' },
  { name: 'dsp_resample_sinc', kind: 'function' },
  { name: 'dsp_resample_sinc_reset', kind: 'function' },
  { name: 'dsp_get_resample_output_ptr', kind: 'function' },
  { name: 'dsp_get_registers', kind: 'function' },
  { name: 'dsp_get_cpu_registers', kind: 'function' },
  { name: 'dsp_get_ram_ptr', kind: 'function' },
  { name: 'dsp_snapshot_size', kind: 'function' },
  { name: 'dsp_snapshot', kind: 'function' },
  { name: 'dsp_restore', kind: 'function' },
